...
public:
    ...
    void start(std::string uri) {
        ...
        printf("%s %s %d uri %s\n", __FILE__, __FUNCTION__, __LINE__, uri.c_str());
    ...
    void send_mseeage() {
		m_endpoint.send(m_handle, "aaaaaaaaa", websocketpp::frame::opcode::text);
...
//void * WssClient::m_instance = NULL;
//
//WssClient* WssClient::CreateWssClient() {
//	if (m_instance == NULL) {
//		m_instance = new WssClientImpl();
//	}
//	return (WssClientImpl*)m_instance;
//}
//
//void WssClient::Run(std::string url) {
//	((WssClientImpl*)m_instance)->start(url);
//}
//
//void WssClient::Quit() {
//	((WssClientImpl*)m_instance)->stop();
//}
//
